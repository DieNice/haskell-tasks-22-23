-- Задание:
-- Последовательность чисел Фибоначчи 0,1,1,2.3,5.8,13,21,... легко определить рекурсивно, задав два первых
-- терминирующих значения и определив любое последующее как сумму двух непосредственно предыдущих:
-- F0 = 0
-- F1 = 1
-- Fn = Fn-1 + Fn-2
...
-- F-2 = —1
-- F-10 = —55
-- Измените определение функции fibonacchi так. чтобы она была определена для всех целых чисел и порождала при
