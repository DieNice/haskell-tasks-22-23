...
-- Определить представителя класса Functor для типа данных
-- GeomPrimitive, который определён следующим образом:
-- fmap (+1) $ Point (Point3D 0 0 0) -> Point (Point3D 1 1 1)
-- fmap (+1) $ LineSegment (Point3D 0 0 0) (Point3D 1 1 1) -> LineSegment (Point3D 1 1 1) (Point3D 2 2 2) 
